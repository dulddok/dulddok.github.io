...
See [the Code documentation]({% link docs/reference/ui-components/code/index.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({% link docs/reference/navigation/main/external.md %}) for more details.
...
See [Customization]({% link docs/reference/customization.md %}) for more information.
...
See [Callouts]({% link docs/reference/ui-components/callouts.md %}) for more information.
