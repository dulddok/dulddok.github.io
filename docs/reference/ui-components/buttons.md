...
Wrap the button in a container that uses the [font-size utility classes]({% link docs/reference/utilities/typography.md %}) to scale buttons:
...
Use the [margin utility classes]({% link docs/reference/utilities/layout.md %}#spacing) to add spacing between two buttons in the same block.
